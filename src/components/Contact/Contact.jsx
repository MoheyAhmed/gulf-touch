          ...
          <div className="Contact_form">
            ...
            >
              ...
              <div className="text-center">
                <button
                  type="submit"
                  className="text-white cursor-pointer transition duration-500 bg-[#be9b3f] hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"
