...
// ✅ استيراد الصور (غير الأسماء حسب صورك)
...
export default function MediaSlider() {
 ...
 const images = [
  { key: Home_OurProjects1_Branding, category: t("Home_OurProjects_Category_Branding") },
  { key: Home_OurProjects1_Website, category: t("Home_OurProjects_Category_Website") },
  { key: Home_OurProjects1_Printing, category: t("Home_OurProjects_Printing") },
  { key: Home_OurProjects1_MediaProduction, category: t("Home_OurProjects_MediaContentProduction") },
  { key: Home_OurProjects1_DigitalMarketing, category: t("Home_OurProjects_DigitalMarketing") },
  { key: Home_OurProjects1_Events, category: t("Home_OurProjects_Event") },

  { key: Home_OurProjects2_Branding, category: t("Home_OurProjects_Category_Branding") },
  { key: Home_OurProjects2_Website, category: t("Home_OurProjects_Category_Website") },
  { key: Home_OurProjects2_Printing, category: t("Home_OurProjects_Printing") },
  { key: Home_OurProjects2_MediaProduction, category: t("Home_OurProjects_MediaContentProduction") },
  { key: Home_OurProjects2_DigitalMarketing, category: t("Home_OurProjects_DigitalMarketing") },
